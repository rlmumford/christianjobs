...
class JobPostForm extends JobForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['rpo_upsell'] = [
      ...
      'rpo' => [
        '#type' => 'checkbox',
        '#title' => $this->t('Upgrade to an Outsourced Recruitment Process <span class="upsell-price pull-right">£2995<span class="tax">+VAT</span></span>'),
    ...
    if (\Drupal::moduleHandler()->moduleExists('cj_membership')) {
      ...
      if (!$membership_in_cart && !$membership) {
        $form['membership']['new'] = [
          '#type' => 'checkbox',
          '#title' => $this->t('Become a Christian Jobs Community Member <span class="upsell-price pull-right">£595<span class="tax">+VAT</span></span>'),
          '#attributes' => [
        ...
        $form['membership']['extend'] = [
          '#type' => 'checkbox',
          '#title' => $this->t('Renew Christian Jobs Community Membership <span class="upsell-price pull-right">£595<span class="tax">+VAT</span></span>'),
          '#attributes' => [
            'class' => ['membership-checkbox'],
          ],
        ];
